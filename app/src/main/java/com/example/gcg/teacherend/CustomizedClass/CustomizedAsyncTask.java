...
public class CustomizedAsyncTask extends AsyncTask {
    ...
    //为什么需要保留这个RecitingWebService，是为了异步操作结束后可以回调主线程做出相应的操作，包括回传异步操作结果
    ...
    //命名空间,在发布的WebService文件里面有，由于我们没有改，默认是这个
    ...
    protected Object doInBackground(Object... params) {
        ...
        //在执行过程中可以调用publicProgress(Progress…)来更新任务的进度，进度条显示。
    ...
    protected void onPostExecute(Object result) {
        ...
        if (result != null) {
            remote.setAnswer(result);//返回结果
        }
        else {
        }
    }
    public Object CallWebService(String MethodName, Map<String, String> MethodParams) {
